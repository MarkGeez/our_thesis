...
Route::middleware(['auth', 'role:admin', 'log.module.visit'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::post('/reports/generate/officials', [ReportsController::class, 'generateOfficials'])->name('reports.officials');
    Route::post('/reports/generate/archives', [ReportsController::class, 'generateArchives'])->name('reports.archives');
    Route::post('/reports/generate/announcements', [ReportsController::class, 'generateAnnouncements'])->name('reports.announcements');
    Route::post('/reports/generate/feedback', [ReportsController::class, 'generateFeedback'])->name('reports.feedback');
