    ...
    <div class="col-md-3">
        <div class="card h-100 text-center shadow-sm action-card" data-bs-toggle="modal" data-bs-target="#modalIndigency">
            <div class="card-body py-4">
                ...
                <p class="text-muted small my-2">Certificate of Indigency</p>
            </div>
        </div>
    </div>
    <div class="col-md-3">
    ...
    <div class="col-md-3">
        <div class="card h-100 text-center shadow-sm action-card" data-bs-toggle="modal" data-bs-target="#modalSenior">
            <div class="card-body py-4">
                ...
                <p class="text-muted small my-2">Senior Residency Certification</p>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="modalBonafide" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <form action="{{ route($formRoute) }}" method="POST">
            ...
            <input type="hidden" name="certificate_name" value="Bonafide Certification">
...
<div class="modal fade" id="modalIndigency" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <form action="{{ route($formRoute) }}" method="POST">
            ...
            <input type="hidden" name="certificate_name" value="Indigency Certification">
            <div class="modal-content">
                <div class="modal-header">
...
<div class="modal fade" id="modalSoloParent" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <form action="{{ route($formRoute) }}" method="POST">
            ...
            <input type="hidden" name="certificate_name" value="Solo Parent Certification">
            <div class="modal-content">
                <div class="modal-header">
...
{{-- Shared JavaScript for all certificate forms --}}
<script>
