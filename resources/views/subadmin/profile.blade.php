...
<main class="main users chart-page container-fluid py-4" id="skip-target">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-7">
                            @if($user->proofOfIdentity)
                                <button class="btn btn-sm btn-outline-secondary" data-bs-toggle="modal" data-bs-target="#proofModalSubadmin">
                                    View Proof
                                </button>
                            @else
   ...
   <div class="row">
    ...
    @if($user->proofOfIdentity)
        <div class="modal fade" id="proofModalSubadmin" tabindex="-1" aria-labelledby="proofModalSubadminLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="proofModalSubadminLabel">Proof of Identity</h5>
