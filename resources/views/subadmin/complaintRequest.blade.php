                        ...
                        <div class="table-responsive">
                            <table id="complaintTable" class="table table-bordered table-hover mb-0 shadow-sm bg-white">
                                ...
                                <tbody id="complaintTableBody" class="align-middle">
                                    ...
                                    @endphp
                                    <tr>
<td class="text-left text-dark" style="font-size: 0.78rem;">{{ $complaint->formatted_id }}</td>                                        <td>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content border-0 shadow-lg">
                                            ...
                                            <form action="{{ route('subadmin.update.complaint', $complaint->id) }}" method="POST" data-loading-text="Saving complaint update...">
                                                @csrf @method('PUT')
