<head>
    ...
    <style>
        ...
        .service-img { width: 48px; height: 48px; object-fit: cover; border-radius: 10px; }
            ...
            <div class="container-fluid py-4">
                <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-3">
                    <div>
                        ...
                        <p class="text-muted small mb-0">Request items from the barangay and monitor your requests.</p>
                    </div>
                </div>
                    ...
                    <div class="col-xl-5">
                        <div class="card card-ghost shadow-sm h-100">
                            <div class="card-body">
                                ...
                                <form method="POST" action="{{ route('resident.service.request.store') }}" class="vstack gap-3">
                                    @csrf
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="remarks" value="{{ old('remarks') }}" class="form-control" placeholder="Anything the barangay should know?">
                                    </div>
                                    <div class="d-grid">
